...
def get_all_users() -> str:
    ...
    Returns:
        str: JSON response containing a list of all users.
    """
...
def get_user_by_id(user_id: str = None) -> str:
    ...
    Returns:
        str: JSON response containing the user data.
...
def create_new_user() -> str:
    ...
    Returns:
        str: JSON response containing the new user data.
...
def update_user_by_id(user_id: str = None) -> str:
    ...
    Returns:
        str: JSON response containing the updated user data.
        404 error if the User ID does not exist.
